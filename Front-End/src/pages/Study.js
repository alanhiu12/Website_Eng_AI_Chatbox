...
const Study = () => {
  const [classes, setClasses] = useState([
    ...
    },
    {
      ...
      name: "Chemistry",
      teacher: "Dr. Brown",
      description: "Explore the basics of chemical reactions.",
      code: "CHEM101",
    },
    {
      id: 4,
      name: "Biology",
      teacher: "Dr. Green",
      description: "Understand the fundamentals of living organisms.",
      code: "BIO101",
    },
    {
      id: 5,
      name: "History",
      teacher: "Mr. Taylor",
      description: "Dive into world history and ancient civilizations.",
      code: "HIST101",
    },
    {
      id: 6,
      ...
      teacher: "Ms. Davis",
      description: "Learn programming fundamentals and algorithms.",
      code: "CS101",
    },
    {
      id: 7,
      ...
      teacher: "Mrs. White",
      description: "Study classic and modern works of literature.",
      code: "ENG101",
    },
  ]);
